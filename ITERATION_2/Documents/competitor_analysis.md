...
| Official UQ System | Official Students of UQ with Login IDs to access all formal and informal UQ information sources | “Institutional Authority & Data Integrity” | a. Data Presentation as is is haphazard, spread out and sometimes incomplete or confusing
b. No one master source of data on course requirements & details, students have to search across different pages examining one course at a time for necessary details
c. No unified template for course details; Descriptions and information often differs from course to course in writing style & presentation
d. Very little immediate feedback if student selects a wrong course, and little corrective advice on how a student’s course plan should be unless in contact with a physical academic/course supervisor |

| AI LLMs | Students with little time or little knowledge of official sources & their data presentation | “The knowledge of the world at your fingertips – and in a tailored form” | a. AI outputs depend on the scope of available information at the model’s disposal, often fixed since their last update
b. AI outputs have the risk of hallucinating fake or nonsensical data which will create sure-fail plans
...
c. Contacts may also not know how to communicate the information verbally or textually accurately – Data integrity issue is now about presentation rather than accuracy | 